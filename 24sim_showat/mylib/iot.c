...
//	esp8266_connect_tcp((char *)ip, "80");
	sprintf(len_buf, "%d", ret);
//	delay_ms(200);
//	esp8266_send_data(send_data, len_buf); 
//	delay_ms(500);
//	esp8266_disconnect();
...
//	if (sim_connect((char *)ip, "80") == 0) {//½¨Á¢Á´½Ó
		sprintf(len_buf, "%d", ret);
		sim_get(send_data, len_buf);	
//	} else {
//		sim_disconnect();
//		return 1;
//	}
